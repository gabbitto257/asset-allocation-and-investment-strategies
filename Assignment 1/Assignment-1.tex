...
\end{tcolorbox}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
/var/folders/tz/0xkfm8xj6vj8njh5rflhfpgh0000gn/T/ipykernel\_31957/22146945.py:40:
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Assignment-1_files/Assignment-1_21_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Assignment-1_files/Assignment-1_24_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
dynamics).
    ...
    \hypertarget{summary-statistics-of-daily-returns}{%
\subsubsection{1.5 Summary statistics of daily
returns}\label{summary-statistics-of-daily-returns}}

To summarise the behaviour of the \textbf{USD daily log returns}, we now
compute a set of basic moments for each index: mean, standard deviation,
...
\end{tcolorbox}
    ...
    We can also summarise the behaviour of the \textbf{local currency daily
log returns}. Here we compute the same set of basic moments for each
index: mean, standard deviation, skewness, (excess) kurtosis and the
first-order autocorrelation.

    \begin{tcolorbox}[breakable, size=fbox, boxrule=1pt, pad at break*=1mm,colback=cellbackground, colframe=cellborder]
\begin{Verbatim}[commandchars=\\\{\}]
\PY{c+c1}{\PYZsh{} Daily log returns (local currency)}
\PY{n}{returns\PYZus{}local} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{log}\PY{p}{(}\PY{n}{prices\PYZus{}local} \PY{o}{/} \PY{n}{prices\PYZus{}local}\PY{o}{.}\PY{n}{shift}\PY{p}{(}\PY{l+m+mi}{1}\PY{p}{)}\PY{p}{)}\PY{o}{.}\PY{n}{dropna}\PY{p}{(}\PY{p}{)}

\PY{n}{returns\PYZus{}local}\PY{o}{.}\PY{n}{head}\PY{p}{(}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
                 TSX       CAC       DAX  Eurostoxx50  NIKKEI225   FTSE100  \textbackslash{}
date
2007-04-02  0.007590  0.002021  0.002907     0.002036  -0.015109  0.001188
2007-04-03  0.007166  0.011684  0.015504     0.013455   0.012584  0.007977
2007-04-04  0.006498  0.004733  0.004016     0.003651   0.017250 -0.000222
2007-04-05 -0.001734  0.000413  0.003669     0.002276  -0.003007  0.005115
2007-04-10  0.000469  0.004326  0.009359     0.006982   0.009857  0.003188

               SP500  IBOVESPA
date
2007-04-02  0.002594 -0.004551
2007-04-03  0.009237  0.015041
2007-04-04  0.001112  0.005730
2007-04-05  0.003045  0.001996
2007-04-10  0.003202  0.011234
\end{Verbatim}
\end{tcolorbox}
        
    \begin{tcolorbox}[breakable, size=fbox, boxrule=1pt, pad at break*=1mm,colback=cellbackground, colframe=cellborder]
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{summary} \PY{o}{=} \PY{n}{pd}\PY{o}{.}\PY{n}{DataFrame}\PY{p}{(}\PY{n}{index}\PY{o}{=}\PY{n}{returns\PYZus{}local}\PY{o}{.}\PY{n}{columns}\PY{p}{)}

\PY{n}{summary}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{mean}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]} \PY{o}{=} \PY{n}{returns\PYZus{}local}\PY{o}{.}\PY{n}{mean}\PY{p}{(}\PY{p}{)}
\PY{n}{summary}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{std}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]} \PY{o}{=} \PY{n}{returns\PYZus{}local}\PY{o}{.}\PY{n}{std}\PY{p}{(}\PY{n}{ddof}\PY{o}{=}\PY{l+m+mi}{1}\PY{p}{)}
\PY{n}{summary}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{skew}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]} \PY{o}{=} \PY{n}{returns\PYZus{}local}\PY{o}{.}\PY{n}{apply}\PY{p}{(}\PY{n}{skew}\PY{p}{)}

\PY{c+c1}{\PYZsh{} \PYZdq{}kurtosis\PYZdq{} in the usual sense (not centred at 3)}
\PY{n}{summary}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{kurtosis}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]} \PY{o}{=} \PY{n}{returns\PYZus{}local}\PY{o}{.}\PY{n}{apply}\PY{p}{(}\PY{k}{lambda} \PY{n}{x}\PY{p}{:} \PY{n}{kurtosis}\PY{p}{(}\PY{n}{x}\PY{p}{,} \PY{n}{fisher}\PY{o}{=}\PY{k+kc}{False}\PY{p}{)}\PY{p}{)}

\PY{c+c1}{\PYZsh{} excess kurtosis = kurtosis − 3}
\PY{n}{summary}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{excess\PYZus{}kurtosis}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]} \PY{o}{=} \PY{n}{returns\PYZus{}local}\PY{o}{.}\PY{n}{apply}\PY{p}{(}\PY{k}{lambda} \PY{n}{x}\PY{p}{:} \PY{n}{kurtosis}\PY{p}{(}\PY{n}{x}\PY{p}{,} \PY{n}{fisher}\PY{o}{=}\PY{k+kc}{True}\PY{p}{)}\PY{p}{)}

\PY{c+c1}{\PYZsh{} first\PYZhy{}order autocorrelation of daily returns}
\PY{n}{summary}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{autocorr\PYZus{}lag1}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]} \PY{o}{=} \PY{n}{returns\PYZus{}local}\PY{o}{.}\PY{n}{apply}\PY{p}{(}\PY{k}{lambda} \PY{n}{x}\PY{p}{:} \PY{n}{x}\PY{o}{.}\PY{n}{autocorr}\PY{p}{(}\PY{n}{lag}\PY{o}{=}\PY{l+m+mi}{1}\PY{p}{)}\PY{p}{)}
...
\begin{Verbatim}[commandchars=\\\{\}]
                 mean       std      skew   kurtosis  excess\_kurtosis  \textbackslash{}
TSX          0.000148  0.012258 -0.940863  21.365833        18.365833
CAC          0.000075  0.015316 -0.158893  11.563660         8.563660
DAX          0.000257  0.014979 -0.118430  11.550073         8.550073
Eurostoxx50  0.000009  0.015405 -0.227407  10.915073         7.915073
NIKKEI225    0.000157  0.015865 -0.419294  10.522641         7.522641
FTSE100      0.000049  0.012931 -0.242582  13.164633        10.164633
SP500        0.000374  0.013581 -0.637448  15.001456        12.001456
IBOVESPA     0.000256  0.018863 -0.292725  12.297993         9.297993

             autocorr\_lag1
TSX              -0.098100
CAC              -0.029844
DAX               0.003019
Eurostoxx50      -0.033778
NIKKEI225        -0.035715
FTSE100          -0.045531
SP500            -0.154566
IBOVESPA         -0.077461
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Assignment-1_files/Assignment-1_37_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Assignment-1_files/Assignment-1_41_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Assignment-1_files/Assignment-1_67_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{tcolorbox}
            ...
            \begin{tcolorbox}[breakable, size=fbox, boxrule=.5pt, pad at break*=1mm, opacityfill=0]
\begin{Verbatim}[commandchars=\\\{\}]
(array([ 2.29123294e-17, -1.65743820e-16, -8.17809318e-19,  5.97683119e-16,
         1.25196383e-01,  2.27230016e-17,  8.74803617e-01, -2.65560562e-17]),
 0.08773417759756144,
 0.1944395532294103,
 0.45121569217991314)
\end{Verbatim}
...
Min weight: -1.6574381969086036e-16
    \end{Verbatim}
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Assignment-1_files/Assignment-1_81_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Assignment-1_files/Assignment-1_84_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Assignment-1_files/Assignment-1_103_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Assignment-1_files/Assignment-1_114_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Assignment-1_files/Assignment-1_118_0.png}
    \end{center}
    { \hspace*{\fill} \\}
